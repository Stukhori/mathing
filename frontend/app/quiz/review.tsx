...
const IPhone1314 = () => {
  ...
  const timeSpent = "9:51"; // You can replace this with actual time tracking later
  ...
  return (
    <View style={styles.iphone131410}>
      <View style={styles.iphone16Pro44}>
        ...
        />
        <Text style={[styles.lessonOverview, styles.textTypo1]}>
          Lesson overview
        </Text>
        ...
        />
        <Text style={[styles.correctAnswers, styles.answersLayout]}>
          {correctCount} correct answers
        </Text>
        <Text style={[styles.wrongAnswers, styles.answersLayout]}>
          {wrongCount} wrong answers
        </Text>
        <Text style={[styles.minutes, styles.timetext]}>
          {timeSpent} minutes
        </Text>
        <Text style={[styles.recommendations, styles.Recommendations]}>
          Recommendations
        </Text>
        <View
          style={[
            styles.recommendation1rectangle,
            styles.recommendationrectangles,
          ]}
        />
        <Text style={[styles.coinamount1, styles.text1Layout]}>10</Text>
        <Image
          style={styles.coiniconleft}
          resizeMode="cover"
          source={require("../../src/img/imagecoin.png")}
        />
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../../src/img/Maskgroup.png")}
        />
        <Text style={[styles.shareResultsWith, styles.setTheoryTypo]}>
          Share results with friends !
        </Text>
        <View style={[styles.viewrectangleleft, styles.iphone16ChildBg]} />
        <Text style={[styles.view, styles.viewLayout]}>View</Text>
        <View
          style={[styles.iphone16Pro44Child2, styles.recommendationrectangles]}
        />
        <Text style={[styles.text2, styles.coinamount]}>20</Text>
        <Image
          style={[styles.image9Icon, styles.image9IconLayout]}
          resizeMode="cover"
          source={require("../../src/img/imagecoin.png")}
        />
        <View
          style={[styles.iphone16Pro44Child3, styles.rectangleViewBorder]}
        />
        <Image
        ...
        <Text style={[styles.treeDiagram, styles.setTheoryTypo]}>
          Tree diagram
        </Text>
        <Radixiconscrosscircled
          style={[styles.radixIconscrossCircled, styles.percentageLayout]}
          width={46}
          height={46}
        />
        ...
        />
        <Lisearch
          style={[styles.lisearchIcon, styles.text1Layout]}
          width={45}
          height={41}
        />
        <Vuesaxlinearhome
        ...
        <Simplelineiconscheck
          style={styles.simpleLineIconscheck}
          width={43}
          height={43}
        />
      </View>
      <Materialsymbolsshareoutline
        style={[styles.materialSymbolsshareOutlineIcon, styles.viewLayout]}
        width={35}
        height={36}
      />
      <Vuesaxlinearheart
