    ...
    <View style={[styles.iphone131434, styles.iphone131434Layout]}>
      <View style={[styles.iphone16Pro36, styles.iphone16Position]}>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../src/img/courses/beginner.png")}
        />
        <View style={[styles.iphone16Pro36Item, styles.iphone16Layout]} />
        <View style={[styles.iphone16Pro36Inner, styles.iphone16Layout]} />
        <Image
          style={[styles.maskGroupIcon1, styles.iconLayout1]}
          resizeMode="cover"
          source={require("../src/img/courses/intermediate.png")}
        />
        <Image
          style={[styles.imageIcon, styles.iconLayout1]}
          resizeMode="cover"
          source={require("../src/img/courses/advanced.png")}
        />
        <Text style={[styles.beginner, styles.beginnerLayout]}>Beginner</Text>
        <Text style={[styles.intermediate, styles.advancedFlexBox]}>
          Intermediate
        </Text>
        ...
        <Image
          style={[styles.imageIcon1, styles.imageIconPosition1]}
          resizeMode="cover"
          source={require("../src/img/courses/algebra.png")}
        />
        <View style={[styles.rectangleView, styles.rectangleViewPosition]} />
        <Text style={[styles.algebra, styles.logicsLayout]}>Algebra</Text>
        <Text
          style={[
            styles.simpleEquationsNumbers,
            styles.simpleEquationsNumbersLayout,
          ]}
        >
          Simple equations, numbers, and basic laws
        </Text>
        <Rectangle181
          style={[styles.iphone16Pro36Child2, styles.imageIcon2Position11]}
        />
        <Image
          style={[styles.imageIcon2, styles.imageIcon2Position]}
          resizeMode="cover"
          source={require("../src/img/courses/logics.png")}
        />
        <View style={[styles.iphone16Pro36Child3, styles.iconPosition]} />
        <Text style={[styles.logics, styles.logicsLayout]}>Logics</Text>
        <Text
          style={[
            styles.reasoningProblemSolvingAn,
            styles.fundamentalOperationsOfTypo,
          ]}
        >
        ...
        <Rectangle178
          style={[styles.iphone16Pro36Child4, styles.imageIconPosition11]}
        />
        <Image
          style={[styles.imageIcon3, styles.imageIconPosition]}
          resizeMode="cover"
          source={require("../src/img/courses/geometry.png")}
        />
        ...
        <Text
          style={[styles.shapesFiguresAngles, styles.shapesFiguresAnglesLayout]}
        >
          Shapes, figures, angles, and key geometry concepts
        </Text>
        <Text style={[styles.text1, styles.textTypo]}>28%</Text>
        <Text style={[styles.text2, styles.textPosition]}>66%</Text>
        <Rectangle184
          style={[styles.iphone16Pro36Child10, styles.imageIconPosition12]}
        />
        <Image
          style={[styles.imageIcon4, styles.imageIconPosition]}
          resizeMode="cover"
          source={require("../src/img/courses/arithmetic.png")}
        />
        <View
          style={[styles.iphone16Pro36Child11, styles.imageIconPosition13]}
        />
        <Text style={[styles.arithmetic, styles.logicsLayout]}>Arithmetic</Text>
        <Text
          style={[
            styles.fundamentalOperationsOf,
            styles.shapesFiguresAnglesLayout,
          ]}
        >
          Fundamental operations of numbers
        </Text>
        <Text style={[styles.text3, styles.textPosition]}>36%</Text>
        <View
          style={[styles.iphone16Pro36Child14, styles.iphone16ChildLayout1]}
        />
        <View
          style={[styles.iphone16Pro36Child15, styles.iphone16ChildLayout1]}
        />
        ...
        <View
          style={[styles.iphone16Pro36Child16, styles.iphone16ChildLayout]}
        />
        <View
          style={[styles.iphone16Pro36Child17, styles.iphone16ChildLayout]}
        />
        ...
        />
        <Lisearch
          style={[styles.lisearchIcon, styles.iphone16ChildLayout2]}
          width={45}
          height={41}
        />
        <Vuesaxlinearhome
