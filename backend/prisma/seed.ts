...
async function main() {
  await prisma.lesson.create({
    data: {
      ...
      description: "Master subtraction fundamentals from basic facts to multi-digit problems",
      difficulty: "BEGINNER",
      order: 4,
      theory: {
        create: [
          {
            ...
            content: "Subtraction is the process of removing objects from a collection. It answers questions like 'How many are left?' or 'What's the difference?'",
            order: 1,
          ...
          },
          {
            ...
            content: "When subtracting larger numbers, sometimes you need to borrow from the next higher place value:",
            order: 2,
            examples: JSON.stringify({
