...
async function main() {
  await prisma.lesson.create({
    data: {
      ...
      description:
        'Master basic number sequences, patterns, and counting skills',
      difficulty: 'BEGINNER',
      order: 1,
      theory: {
        create: [
          {
            ...
            content:
              'Number sequences are ordered lists of numbers that follow a specific pattern or rule. Recognizing these patterns helps us predict future numbers in the sequence.',
            order: 1,
          ...
          },
          {
            ...
            examples: JSON.stringify({
              'Example 1':
                'For 3, 6, __, 12: Differences are +3, so missing number is 9',
              'Example 2':
                'For 125, 150, __, 200: Differences are +25, so missing number is 175',
            }),
          },
        ],
      },
        ...
        create: [
          {
            ...
            order: 1,
            explanation:
              'The sequence increases by 2 each time. After 4 comes 6.',
            choices: {
              create: [
          ...
          },
          {
            ...
            order: 2,
            explanation:
              'The sequence increases by 5 each time. After 15 comes 20.',
            choices: {
              create: [
          ...
          },
          {
            ...
            order: 7,
            explanation:
              'The sequence increases by 25 each time. 150 + 25 = 175',
            choices: {
              create: [
          ...
          },
          {
            ...
            order: 9,
            explanation:
              'The sequence decreases by 50 each time. 450 - 50 = 400',
            choices: {
              create: [
          ...
          },
          {
            ...
            order: 10,
            explanation:
              'The differences increase by 2 each time (+3, +5, +7, +9, +11)',
            choices: {
              create: [
